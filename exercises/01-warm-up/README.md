...
- Bruk **Copilot Chat** til å forklare eksisterende kode
...
- Bruk **Claude Code i Plan Mode** (trykk Shift+Tab to ganger) for å undersøke hvordan man legger til dark mode toggle
- Les gjennom planen og forstå arkitekturen
